...
function addCarrinho(produto, valor) {
    ...
    if (!fim) {
        carrinho.push({ produto, valor, qtd: 1 }); // a função push é para puxar as informação do carrinho
    }
    atualizaCarrinho();
}
...
function atualizaCarrinho() {
    const cartItens = document.getElementById('carrinho-itens'); // função que atualizar e adicionar informação ao carrinho
    cartItens.innerHTML = '';
    total = 0;
